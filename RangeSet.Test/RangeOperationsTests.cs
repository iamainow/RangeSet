...
public class RangeOperationsTests
{
    ...
    public void Sort_SingleElement_RemainsUnchanged()
    {
        ...
        span[0] = new Range<int>(5, 10);
        
        RangeOperations.Sort(span);
        
        Assert.Equal(new Range<int>(5, 10), span[0]);
    }
    ...
    public void Sort_AlreadySorted_RemainsUnchanged()
    {
        ...
        span[1] = new Range<int>(10, 15);
        span[2] = new Range<int>(20, 25);
        
        RangeOperations.Sort(span);
        
        Assert.Equal(new Range<int>(1, 5), span[0]);
        Assert.Equal(new Range<int>(10, 15), span[1]);
        Assert.Equal(new Range<int>(20, 25), span[2]);
    }
    ...
    {
        Span<Range<int>> span = stackalloc Range<int>[3];
        span[0] = new Range<int>(20, 25);
        span[1] = new Range<int>(10, 15);
        span[2] = new Range<int>(1, 5);
    ...
    public void Sort_Unsorted_SortsByFirstValue()
    {
        ...
        span[0] = new Range<int>(100, 200);
        span[1] = new Range<int>(1, 10);
        span[2] = new Range<int>(50, 60);
        span[3] = new Range<int>(5, 15);
        
        RangeOperations.Sort(span);
        
        Assert.Equal(new Range<int>(1, 10), span[0]);
        Assert.Equal(new Range<int>(5, 15), span[1]);
        Assert.Equal(new Range<int>(50, 60), span[2]);
        Assert.Equal(new Range<int>(100, 200), span[3]);
    }
    ...
    {
        Span<Range<int>> span = stackalloc Range<int>[3];
        span[0] = new Range<int>(10, 20);
        span[1] = new Range<int>(10, 20);
        span[2] = new Range<int>(10, 20);
        
        RangeOperations.Sort(span);
        
        Assert.Equal(new Range<int>(10, 20), span[0]);
        Assert.Equal(new Range<int>(10, 20), span[1]);
        Assert.Equal(new Range<int>(10, 20), span[2]);
    }
    ...
    public void NormalizeSorted_Overlapping_MergesRanges()
    {
        ...
        Assert.Equal(new Range<int>(1, 15), span[0]);
    ...
    public void NormalizeSorted_Adjacent_MergesRanges()
    {
        ...
        span[2] = new Range<int>(21, 30);
        
        int result = RangeOperations.NormalizeSorted(span);
        
        Assert.Equal(1, result);
        Assert.Equal(new Range<int>(1, 30), span[0]);
    }
    ...
    public void NormalizeSorted_Contained_MergesIntoOuter()
    {
        ...
        Assert.Equal(1, result);
        Assert.Equal(new Range<int>(1, 100), span[0]);
    }
    ...
    public void NormalizeSorted_AllOverlapping_MergesIntoSingle()
    {
        ...
        span[0] = new Range<int>(1, 10);
        span[1] = new Range<int>(5, 20);
        span[2] = new Range<int>(15, 30);
        span[3] = new Range<int>(25, 40);
        span[4] = new Range<int>(35, 50);
        
        int result = RangeOperations.NormalizeSorted(span);
        
        Assert.Equal(1, result);
        Assert.Equal(new Range<int>(1, 50), span[0]);
    }
    ...
    public void NormalizeSorted_AtMaxValue_HandlesCorrectly()
    {
        ...
        span[0] = new Range<int>(1, int.MaxValue - 1);
        span[1] = new Range<int>(int.MaxValue, int.MaxValue);
        
        int result = RangeOperations.NormalizeSorted(span);
        
        Assert.Equal(1, result);
        Assert.Equal(new Range<int>(1, int.MaxValue), span[0]);
    }
    ...
    {
        Span<Range<int>> span = stackalloc Range<int>[3];
        span[0] = new Range<int>(20, 30);
        span[1] = new Range<int>(1, 10);
        span[2] = new Range<int>(5, 15);
    ...
    public void UnionNormalizedNormalized_FirstEmpty_ReturnsSecond()
    {
        ...
        normalized2[0] = new Range<int>(1, 5);
        normalized2[1] = new Range<int>(10, 15);
        Span<Range<int>> result = stackalloc Range<int>[10];
        
        int count = RangeOperations.UnionNormalizedNormalized([], normalized2, result);
        
        Assert.Equal(2, count);
        Assert.Equal(new Range<int>(1, 5), result[0]);
        Assert.Equal(new Range<int>(10, 15), result[1]);
    }
    ...
    public void UnionNormalizedNormalized_SecondEmpty_ReturnsFirst()
    {
        ...
        normalized1[0] = new Range<int>(1, 5);
        normalized1[1] = new Range<int>(10, 15);
        Span<Range<int>> result = stackalloc Range<int>[10];
    ...
    public void UnionNormalizedNormalized_NonOverlapping_ReturnsBoth()
    {
        Span<Range<int>> normalized1 = stackalloc Range<int>[2];
        normalized1[0] = new Range<int>(1, 5);
        normalized1[1] = new Range<int>(20, 25);
        Span<Range<int>> normalized2 = stackalloc Range<int>[2];
        normalized2[0] = new Range<int>(10, 15);
        normalized2[1] = new Range<int>(30, 35);
        Span<Range<int>> result = stackalloc Range<int>[10];
        ...
        Assert.Equal(new Range<int>(1, 5), result[0]);
        Assert.Equal(new Range<int>(10, 15), result[1]);
        Assert.Equal(new Range<int>(20, 25), result[2]);
        Assert.Equal(new Range<int>(30, 35), result[3]);
    }
    ...
    public void UnionNormalizedNormalized_Overlapping_Merges()
    {
        ...
        normalized1[0] = new Range<int>(1, 10);
        Span<Range<int>> normalized2 = stackalloc Range<int>[1];
        normalized2[0] = new Range<int>(5, 15);
        Span<Range<int>> result = stackalloc Range<int>[10];
    ...
    public void UnionNormalizedNormalized_Adjacent_Merges()
    {
        ...
        normalized1[0] = new Range<int>(1, 10);
        Span<Range<int>> normalized2 = stackalloc Range<int>[1];
        normalized2[0] = new Range<int>(11, 20);
        Span<Range<int>> result = stackalloc Range<int>[10];
        
        int count = RangeOperations.UnionNormalizedNormalized(normalized1, normalized2, result);
        
        Assert.Equal(1, count);
        Assert.Equal(new Range<int>(1, 20), result[0]);
    }
    ...
    public void UnionNormalizedNormalized_ResultOverlapsFirst_ThrowsArgumentException()
    {
        Assert.Throws<ArgumentException>(() =>
        {
            ...
            normalized1[0] = new Range<int>(1, 10);
            Span<Range<int>> normalized2 = stackalloc Range<int>[1];
            normalized2[0] = new Range<int>(20, 30);
    ...
    {
        Span<Range<int>> normalized1 = stackalloc Range<int>[1];
        normalized1[0] = new Range<int>(1, int.MaxValue);
        Span<Range<int>> normalized2 = stackalloc Range<int>[1];
        normalized2[0] = new Range<int>(100, 200);
        Span<Range<int>> result = stackalloc Range<int>[10];
        
        int count = RangeOperations.UnionNormalizedNormalized(normalized1, normalized2, result);
        
        Assert.Equal(1, count);
        Assert.Equal(new Range<int>(1, int.MaxValue), result[0]);
    }
    ...
    public void ExceptNormalizedSorted_SortedEmpty_ReturnsNormalized()
    {
        ...
        normalized[0] = new Range<int>(1, 5);
        normalized[1] = new Range<int>(10, 15);
        Span<Range<int>> result = stackalloc Range<int>[10];
    ...
    public void ExceptNormalizedSorted_NoOverlap_ReturnsNormalized()
    {
        ...
        normalized[0] = new Range<int>(1, 10);
        Span<Range<int>> sorted = stackalloc Range<int>[1];
        sorted[0] = new Range<int>(20, 30);
        Span<Range<int>> result = stackalloc Range<int>[10];
    ...
    {
        Span<Range<int>> normalized = stackalloc Range<int>[1];
        normalized[0] = new Range<int>(1, 20);
        Span<Range<int>> sorted = stackalloc Range<int>[1];
        sorted[0] = new Range<int>(5, 10);
        Span<Range<int>> result = stackalloc Range<int>[10];
        
        int count = RangeOperations.ExceptNormalizedSorted(normalized, sorted, result);
        
        Assert.Equal(2, count);
        Assert.Equal(new Range<int>(1, 4), result[0]);
        Assert.Equal(new Range<int>(11, 20), result[1]);
    }
    ...
    {
        Span<Range<int>> normalized = stackalloc Range<int>[1];
        normalized[0] = new Range<int>(1, 100);
        Span<Range<int>> sorted = stackalloc Range<int>[3];
        sorted[0] = new Range<int>(10, 20);
        sorted[1] = new Range<int>(30, 40);
        sorted[2] = new Range<int>(50, 60);
        Span<Range<int>> result = stackalloc Range<int>[10];
        
        int count = RangeOperations.ExceptNormalizedSorted(normalized, sorted, result);
        
        Assert.Equal(4, count);
        Assert.Equal(new Range<int>(1, 9), result[0]);
        Assert.Equal(new Range<int>(21, 29), result[1]);
        Assert.Equal(new Range<int>(41, 49), result[2]);
        Assert.Equal(new Range<int>(61, 100), result[3]);
    }
    ...
    {
        Span<Range<int>> normalized = stackalloc Range<int>[1];
        normalized[0] = new Range<int>(int.MinValue, 100);
        Span<Range<int>> sorted = stackalloc Range<int>[1];
        sorted[0] = new Range<int>(int.MinValue, 0);
        Span<Range<int>> result = stackalloc Range<int>[10];
        
        int count = RangeOperations.ExceptNormalizedSorted(normalized, sorted, result);
        
        Assert.Equal(1, count);
        Assert.Equal(new Range<int>(1, 100), result[0]);
    }
    ...
    {
        Span<Range<int>> normalized = stackalloc Range<int>[1];
        normalized[0] = new Range<int>(0, int.MaxValue);
        Span<Range<int>> sorted = stackalloc Range<int>[1];
        sorted[0] = new Range<int>(int.MaxValue, int.MaxValue);
        Span<Range<int>> result = stackalloc Range<int>[10];
        
        int count = RangeOperations.ExceptNormalizedSorted(normalized, sorted, result);
        
        Assert.Equal(1, count);
        Assert.Equal(new Range<int>(0, int.MaxValue - 1), result[0]);
    }
    ...
    {
        Span<Range<int>> normalized2 = stackalloc Range<int>[1];
        normalized2[0] = new Range<int>(1, 10);
        Span<Range<int>> result = stackalloc Range<int>[10];
    ...
    public void IntersectNormalizedNormalized_PartialOverlap_ReturnsIntersection()
    {
        ...
        Assert.Equal(1, count);
        Assert.Equal(new Range<int>(5, 10), result[0]);
    }
    ...
    {
        Span<Range<int>> normalized1 = stackalloc Range<int>[1];
        normalized1[0] = new Range<int>(1, 100);
        Span<Range<int>> normalized2 = stackalloc Range<int>[1];
        normalized2[0] = new Range<int>(20, 30);
        Span<Range<int>> result = stackalloc Range<int>[10];
        ...
        Assert.Equal(1, count);
        Assert.Equal(new Range<int>(20, 30), result[0]);
    }
    ...
    public void IntersectNormalizedNormalized_MultipleRanges_ReturnsAllIntersections()
    {
        ...
        normalized1[0] = new Range<int>(1, 5);
        normalized1[1] = new Range<int>(10, 15);
        normalized1[2] = new Range<int>(20, 25);
        Span<Range<int>> normalized2 = stackalloc Range<int>[2];
        normalized2[0] = new Range<int>(3, 12);
        normalized2[1] = new Range<int>(18, 22);
        Span<Range<int>> result = stackalloc Range<int>[10];
        
        int count = RangeOperations.IntersectNormalizedNormalized(normalized1, normalized2, result);
        
        Assert.Equal(3, count);
        Assert.Equal(new Range<int>(3, 5), result[0]);
        Assert.Equal(new Range<int>(10, 12), result[1]);
        Assert.Equal(new Range<int>(20, 22), result[2]);
    }
